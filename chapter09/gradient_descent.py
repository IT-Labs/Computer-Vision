...
def sigmoid_deriv(x):
    # compute the derivative o the sigmoid function ASSUMING
...
for epoch in np.arange(0, args["epochs"]):
    ...
    # function, thereby giving us our predictions on the datasets
    preds = sigmoid_activation(trainX.dot(W))

    # not that we have our predictions, we need to determine the
    ...
    # term "gradient descent" by taking al small step towards a set of "more optimal" parameters
